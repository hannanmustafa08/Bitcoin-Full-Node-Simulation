...
def stringifyTransaction(Tx): #operates on the Transaction object and converts it a string. 
    ...
    #This is a standard output for coverting a Transaction into a string
    return outputString
